...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate, EDHFinderDelegate {
    ...
    func setAppearance() {
        // 118, 122, 133
        // #767a85
        // UIColor(red:0.2, green:0.29, blue:0.37, alpha:1.0)
        // UIColor(red:0.17, green:0.24, blue:0.31, alpha:1.0)
        //
        
        let themeColor = UIColor(red:0.15, green:0.68, blue:0.38, alpha:1.0)
