...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "EDHFinder/Pod/Assets/EDHFinder.bundle"
  install_resource "EDHFontSelector/Pod/Assets/EDHFontSelector.bundle"
  install_resource "EDHUtility/Pod/Assets/EDHUtility.bundle"
